...
> **站点**: Te3.lsn189.cn | **版本**: v2.6-TAES | **更新**: 2026-01-23
>
...
> **人操作 TU（业务对象），AI 读 AC（业务语境）**
>
> TeamsEdge 的价值 = **优化 TU 操作** + **丰富 AC 语境**
...
│  ─────────────────────────────────────────────────────────────  │
│                                                                 │
│  TU 实例：Player, E队, AO, AR, Teamsbox, Mission...            │
│  AC 特性：独立于 TU，与团队同寿，多个 TU 可共享同一 AC          │
│  CA 作用：关联 TU 与其对应的 AC                                 │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
```

### TU (TeamsEdge Unit) — 业务对象

```
┌─────────────────────────────────────────────────────────────────┐
│  TU (TeamsEdge Unit) — 可操作的业务对象                          │
├─────────────────────────────────────────────────────────────────┤
│                                                                 │
│  定义：TeamsEdge 中可操作的业务实体                             │
│                                                                 │
│  TU 实例（与 TAES 菜单对齐）：                                  │
...
│  属性：                                                         │
│  ├── tu_id: string        // 业务对象标识                       │
│  ├── tu_type: enum        // 对象类型（player, team, org...）   │
...
| 术语 | 全称 | 定义 | 给谁用 | 生命周期 |
|:----:|------|------|:------:|:--------:|
| **TU** | TeamsEdge Unit | 可操作的业务对象 | 人类 | 持久 |
| **AC** | Augment Context | 团队心智（TU 的语境层） | AI | 与团队同寿 |
| **CA** | Context Address | TU 与 AC 的关联指针 | 系统 | — |
