...
| **公司代号** | TC1 |
| **英文名称** | TeraTeams Inc. |
| **注册商标** | TeraTeams ®️ · E队 ®️ |
| **银行账号** | 31001511980056004001|
| **开户行** | 建行上海普陀支行 |
| **联系电话** | 021-62450050 |
| **注册地址** | 上海市普陀区云岭西路600弄6号4052室 |
| **网址** | https://Terateams.com|
...
| **英文商标** | TeraTeams®，粗体无衬线，顶部居中 | 深蓝 + 金色® |
| **中文商标** | TeraTeams® · E队® | 深蓝 + 金色® |
...
│                                                                                                                      │
│  ┌─────┐  ┌─────────────────┐                公司: 上海万联信息科技有限公司               ┌────────┐ ┌────────┐  ┌─────┐│
│  │     │  │  ╭───────────╮  │                账号: 31001511980056004001                  │        │ │        │  │     ││
│  │ 左  │  │  │ · · · · · │  │                开户行: 建行上海普陀支行                    │  QR 1  │ │  QR 2  │  │ 右  ││
│  │ 侧  │  │  │ TeraTeams®│  │                电话: 021-62450050                         │  占位  │ │  占位  │  │ 侧  ││
│  │ 留  │  │  │TeraTeams·E队│  │                地址: 上海市普陀区云岭西路600弄6号         │        │ │        │  │ 留  ││
│  │ 白  │  │  │ · · · · · │  │                                                            └────────┘ └────────┘  │ 白  ││
│  │     │  │  ╰───────────╯  │                                                                                    │     ││
│  └─────┘  └─────────────────┘                                                                                    └─────┘│
│                                                                                                                      │
...
### 变体 B：单码简洁版
```
A professional corporate stamp and information panel on a pure white background, designed for A4 width with 10mm margins and 30mm height. The left side features a dark blue circular stamp with "TeraTeams®" and "TeraTeams® · E队®". The right side contains three lines: "上海万联信息科技有限公司", "账号: 31001511980056004001", "开户行: 建行上海普陀支行". One rectangular QR placeholder on the far right. Aspect ratio 19:3.
```
- 比例：19:3
- 仅 3 行文字 + 单 QR 码
- 适用于：简洁收款场景
...
### 变体 C：纯信息版（无 QR 码）
```
A professional corporate stamp and company header on a pure white background, designed for A4 width with 10mm margins and 30mm height. The left side features a dark blue circular stamp with "TeraTeams®" and "TeraTeams® · E队®". The right side displays five lines of company information: "上海万联信息科技有限公司", "账号: 31001511980056004001", "开户行: 建行上海普陀支行", "电话: 021-62450050", "地址: 上海市普陀区云岭西路600弄6号4052室" in right-aligned dark blue text. No QR code areas. Aspect ratio 19:3.
```
- 比例：19:3
- 适用于：官方文件抬头、信纸头部
...
| 数量 | 2 个（并排放置） |
| 来源 | 微信/支付宝官方导出 |
| 命名 | `TC1-QRCode-1.png`, `TC1-QRCode-2.png` |
...
```
TC1-Logo-Stamp-{变体}-{版本}.png

示例：
- TC1-Logo-Stamp-DualQR-v1.png     (双码收款版)
- TC1-Logo-Stamp-SingleQR-v1.png   (单码简洁版)
- TC1-Logo-Stamp-Header-v1.png     (纯信息版)
```
...
| 文件 | 状态 | 说明 |
|------|------|------|
| `TC1-Logo-Stamp-Base.png` | ⬜ 待生成 | Gemini 生成的底图 |
| `TC1-QRCode-1.png` | ⬜ 待准备 | 第一个 QR 码（如微信收款） |
| `TC1-QRCode-2.png` | ⬜ 待准备 | 第二个 QR 码（如支付宝收款） |
| `TC1-Logo-Stamp-Final.png` | ⬜ 待合成 | 最终合成版本 |

---

*Last Updated: 2026-01-02 | Version: v1.1 (上海万联信息科技有限公司)*
