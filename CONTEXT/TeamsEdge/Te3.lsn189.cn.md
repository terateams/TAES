...
- MU / AC / CA / CP 等概念说明已独立到：`Te3.lsn189.cn.explainer.md`
- ATP/TP/AC 与 TeamsEdge × VS Code 双主场模型详见：`ATP框架.md`
...
> **阅读提示**：以下保留 **A 的菜单清单/路由/地址段与页面结构**。与 [A] 相关的说明（Augment 三支柱、AC/CA/ACD/ACC 术语、Context Protocol、AR/MU 关系与洞见）已抽离至 [Te3.lsn189.cn.A.explainer.md](Te3.lsn189.cn.A.explainer.md)。
...
> **说明**：AC 的术语体系（AC/ACC/ACD/CA）、Context Protocol、ACD 四象限、AR/MU 关系与洞见，见 [Te3.lsn189.cn.A.explainer.md](Te3.lsn189.cn.A.explainer.md)。
